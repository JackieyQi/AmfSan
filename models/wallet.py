...
import time
from peewee import IntegerField, CharField, DecimalField, TimestampField
...
class BalanceHistoryTable(Base):
    ...
    amount = DecimalField(null=False, db_column="amount", default=0, max_digits=20, decimal_places=8)
    price = DecimalField(null=True, db_column="price", default=0, max_digits=20, decimal_places=8)
    bid_coin = CharField(null=False, db_column="bid_coin", max_length=10)
    create_ts = IntegerField(null=False, db_column="create_ts", default=int(time.time()))
