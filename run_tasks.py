...
from amf_consumers import AmfConsumer, AmfPlotConsumer, AmfMsgConsumer, AmfKlineConsumer
...
def main():
    ...
    parser.add_argument("component",
                        type=str,
                        choices=["consumer", "plot_consumer", "msg_consumer", "kline_consumer", "scheduler"],
